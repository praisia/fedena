...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"exam_id"=>nil, "batch_id"=>nil, "student_id"=>nil, "descriptive_indicator_id"=>nil}
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"is_deleted"=>nil, "course_id"=>nil, "name"=>nil, "is_active"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "batch_id"=>nil, "student_id"=>nil, "observable_id"=>nil, "observable_type"=>nil}
  ...
  add_index "subject_leaves", ["month_date", "subject_id", "batch_id"], :name => "index_subject_leaves_on_month_date_and_subject_id_and_batch_id", :limit => {"month_date"=>nil, "subject_id"=>nil, "batch_id"=>nil}
