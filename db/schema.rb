...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"exam_id"=>nil, "student_id"=>nil, "descriptive_indicator_id"=>nil, "batch_id"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_type"=>nil, "observable_id"=>nil, "exam_id"=>nil, "student_id"=>nil, "batch_id"=>nil}
  ...
  add_index "subject_leaves", ["month_date", "subject_id", "batch_id"], :name => "index_subject_leaves_on_month_date_and_subject_id_and_batch_id", :limit => {"subject_id"=>nil, "month_date"=>nil, "batch_id"=>nil}
